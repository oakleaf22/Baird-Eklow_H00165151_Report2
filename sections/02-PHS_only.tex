...
However, PHS can also work well to compensate for the intermittent nature of RE generation from wind or solar \citep{Kocher-Oberlehner2014}.
...
While the capital cost is a long-term investment with a typical payback time of 20 to 40~years, it is worthy to consider that operational and maintenance (O\&M) costs are low the typical lifetime of a PHS plant ranges from 40 to 100 years, or even more \citep{Kocher-Oberlehner2014, Zach2012, Chen2009}.
...
Constructing and deploying a PHS scheme entails some major constraints, including a high capital cost and an approximate lead in time of 10 years.
...
A scheme located in the vicinity of the generation centres and near the main national grid is thus ideal \citep{Louwinger2008}.
...
Since the power costs are so small compared to the storage costs, it is assumed the power costs are included in the storage costs.
