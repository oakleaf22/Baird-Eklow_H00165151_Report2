...
\subsection{Costs}
The Capital Costs of PHS plants can range from as low as 500 \$/kWh to 8000
\$/kWh. In terms of capacity, this means between the range of 1000 \$/kW and
6000 \$/kW. While the Capital Cost is a long term investment with typical
payback time of 20 to 40 years, it is worthy to consider that its typical
lifetime of a PHS plant is over 100 years. The large variations in kWh and
payback time correlates with variations arrising from differences in site
...
fact, the cost per cycle KWh of PHS and CAES are the lowest of all the EES
...
PHES plants tend to be operational for a duration of 50 to 100 years with a
high capital cost and low operational and maintenance (O\&M) cost. There is no
fixed or standard project cost for PHES systems because this cost very much
depends on the intended site with quoted costs may varying from 450 - 2500
euros/kW.  The capital cost is not solely dependent on the installed power but
also on the energy storage (reservoirs) and power rating at the given site.
Being a mature technology, PHES' capital cost is not expected to change
...
When it comes to constructing and depolying a PHES entails some major
